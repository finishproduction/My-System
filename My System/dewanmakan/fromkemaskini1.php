...
$jadual1=mysqli_query($con,"select * from jadual1 where Masa='$Masa'");
$row=mysqli_fetch_array($dewanmakan);
?>

<form method="POST" action="prosupdate1.php">
<h3 align="center">UPDATE Minggu 1</h3>
...
<center>
	...
	<br>
	<input type="button" value="Back to jadual DM"
</center>
</form>
</body>